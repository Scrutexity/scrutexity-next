...
export const metadata: Metadata = {
  title: 'Scrutexity vs. Boulevard Billie — Why Native AI Isn’t Enough',
  description:
    'Boulevard Billie is a native AI add-on for the Boulevard PMS. Scrutexity is a governed missed-demand recovery layer with multi-channel follow-up, deep recovery sequencing, and cross-location reporting.',
  alternates: { canonical: '/vs-boulevard-billie' },
};
...
const comparisonRows = [
  {
    ...
    competitor:
      'Native AI receptionist focused on first-touch reply and same-day booking. No multi-touch reactivation cadence for dormant leads or no-shows beyond default follow-ups.',
    scrutexity:
  ...
  },
  {
    ...
    competitor:
      'Primarily a single-channel reply layer inside the Boulevard inbox (SMS + voice). IG DM, web-form, and missed-call replays sit in separate queues.',
    scrutexity:
  ...
  },
  {
    ...
    competitor:
      'Reporting surfaces inside the Boulevard dashboard. Attribution shows AI-assisted bookings but does not expose the underlying funnel of inquiries → reply → booking → deposit at the row level.',
    scrutexity:
  ...
  },
  {
    ...
    competitor:
      'Roll-up reporting is scoped per Boulevard tenant. Multi-location MSOs typically stitch reports manually or in a BI tool downstream.',
    scrutexity:
  ...
  },
  {
    ...
    competitor:
      'Native AI follows Boulevard’s guardrails; clinical handover behavior is configured inside the platform.',
    scrutexity:
  ...
  },
  {
    ...
    competitor: 'Lives inside Boulevard; turn-on is configuration of an existing module.',
    scrutexity:
      'Read-only API connection to Boulevard. No migration, no stack change, no workflow change for the front desk. Disconnect in one click from Boulevard settings.',
  },
];

const faq = [
  {
    question: 'Why not just use what Boulevard already built?',
    answer:
      'If Billie covers your needs, use it. Scrutexity is for clinics that need deeper recovery sequencing across more channels, cleaner attribution down to the deposit, and cross-location reporting that a single PMS tenant does not expose. We install read-only on top of Boulevard — you do not have to choose.',
  },
  {
    question: 'Does Scrutexity replace Boulevard or Billie?',
    answer:
      'No. Boulevard remains your booking system of record. Scrutexity sits alongside it as a governed recovery layer and writes confirmed bookings back through the same Boulevard workflow your front desk already uses.',
  },
  {
...
export default function VsBoulevardBilliePage() {
  return (
    <div className="min-h-screen bg-cream text-espresso">
      ...
      <header className="relative overflow-hidden border-b border-sand-deep px-5 py-20 sm:px-8 lg:py-28">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          >
            Scrutexity vs. Boulevard Billie — Why Native AI Isn’t Enough
          </h1>
          <p className="mx-auto mt-6 max-w-xl text-sm leading-6 text-mist">
            Billie answers first. Scrutexity recovers the rest — across every channel, every dormant lead, every location.
          </p>
        ...
        <section aria-labelledby="comparison-heading">
          <div className="mb-9 max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-mist">
              Boulevard Billie is a feature inside the PMS. Scrutexity is a focused recovery and reporting layer that runs alongside it. Both can co-exist; this page is for buyers who want to know what the gap is.
            </p>
          </div>
        ...
        <section className="mt-16 grid gap-8 lg:grid-cols-[1fr_0.75fr]">
          <div>
            ...
            <p className="mt-6 text-xs leading-6 text-[#8f8174]">
              Boulevard and Billie are trademarks of their respective owner. Scrutexity is not affiliated with or endorsed by
              Boulevard. Product capabilities can change; buyers should confirm current behavior directly with each vendor.
            </p>
          </div>
