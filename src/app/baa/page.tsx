    ...
    <div className="min-h-screen bg-cream py-20">
      <div className="max-w-3xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-serif text-espresso">Business Associate Agreement</h1>
          <p className="mt-4 text-lg text-espresso/70">Our commitment to HIPAA compliance and data protection</p>
        </div>
        ...
        <div className="prose prose-lg max-w-none text-espresso/80">
          ...
          <h2>Get Your BAA</h2>
          <p>The full BAA is executed as part of the onboarding process. For review before signing, contact <a href="mailto:nick@scrutexity.com" className="text-clay hover:underline">nick@scrutexity.com</a>.</p>
        </div>
      </div>
    </div>
  );
