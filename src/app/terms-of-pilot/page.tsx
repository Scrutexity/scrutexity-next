...
export const metadata = {
  title: 'Terms of Pilot | Scrutexity',
...
export default function TermsOfPilot() {
  return (
    <main className="min-h-screen bg-ivory text-[#221f1b] font-sans selection:bg-terracotta/20 pt-32 pb-24 px-6 flex flex-col">

      <div className="max-w-4xl mx-auto flex-1 w-full bg-white p-8 md:p-12 rounded-3xl border border-charcoal/10 shadow-xl">
        <h1 className="text-4xl md:text-5xl font-extrabold text-charcoal font-display mb-8">Terms of Pilot</h1>
        <p className="text-sm uppercase tracking-widest font-sans font-bold text-charcoal/50 mb-12">Last Updated: June 2026</p>

        <div className="prose prose-lg max-w-none font-sans prose-headings:font-display prose-headings:font-bold prose-p:leading-relaxed prose-p:text-[#5f574f] prose-headings:text-[#221f1b] prose-strong:text-[#221f1b]">
          ...
          <ul>
            ...
            <li><strong>Counting Methodology:</strong> Only entries in the recovery ledger qualify. Scrutexity counts logged administrative events; it does not calculate, estimate, or claim clinical or procedure revenue. Any downstream value is the Clinic's own to assess.</li>
