...
const RECEIPT_FIELDS = [
  ...
  { label: 'Safer rewrite', example: 'Delivered per claim in attached Claim Intelligence Report' },
...
const FAQS = [
  {
    q: 'Does the Claim Intelligence Receipt certify compliance?',
    ...
    <div className="rounded-2xl border border-sand-deep/35 bg-bone overflow-hidden" style={{ boxShadow: '0 20px 48px -16px rgba(28,24,20,0.12), inset 0 1px 1px rgba(255,255,255,0.6)' }}>
      ...
      <div className="flex items-center justify-between gap-4 px-6 py-4 border-b border-sand-deep/25 bg-cream/70">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[10px] font-mono uppercase tracking-[0.18em] text-sage-deep font-semibold">Claim Intelligence Receipt</p>
...
export default function ClaimIntelligenceReceiptPage() {
  return (
    <div className="min-h-screen bg-cream text-bark font-sans selection:bg-clay/20">
      <title>Claim Intelligence Receipt for Agencies | AuditGPT by Scrutexity</title>
      <meta name="description" content="The Claim Intelligence Receipt is the agency CYA document: a structured record of what was reviewed, what proof was found, what language was adjusted, and what the client approved before a high-claim page launched." />
      ...
      <section className="relative px-6 pt-32 pb-20 md:pt-44 md:pb-28 bg-cream-deep border-b border-sand-deep/20 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: EASE }} className="inline-flex items-center gap-2 mb-6" style={{ fontFamily: MONO }}>
            ...
            <span className="text-[11px] uppercase tracking-[0.2em] text-sage-deep font-semibold">Agency Product · Claim Intelligence Receipt</span>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <motion.p initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.85, ease: EASE, delay: 0.18 }} className="mt-6 text-base md:text-lg text-mist leading-[1.65]">
                Before your agency launches GLP-1, body-contouring, IV therapy, exosome, or RF microneedling pages, give the client a Claim Intelligence Receipt — showing what was reviewed, what proof was found, what language was adjusted, and what the client approved.
              </motion.p>
      ...
      <section className="px-6 py-20 bg-bone border-b border-sand-deep/15">
        <div className="max-w-5xl mx-auto">
          <div className="max-w-2xl mb-12">
            ...
            <h2 className="font-display text-3xl md:text-4xl text-espresso tracking-[-0.02em] leading-[1.1]">
              Six page types that need a Claim Intelligence Receipt before launch.
            </h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-3">
            {[
              ...
              { step: '03', label: 'Generate Receipt', detail: 'Claim Intelligence Receipt with support/missing/safer-rewrite per claim' },
      ...
      <section className="px-6 py-20 bg-cream text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-6 text-[10px] text-mist/50 max-w-xl mx-auto leading-relaxed" style={{ fontFamily: MONO }}>
            Not legal advice. Not medical advice. Not regulatory certification. The Claim Intelligence Receipt documents a claim-review process, not compliance with any regulatory requirement.
          </p>
        </div>
      </section>
    </div>
