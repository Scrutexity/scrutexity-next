...
const OS_LAYERS: OperatingLayer[] = [
  { id: 'find', name: 'Find', product: 'AuditGPT', input: 'Website', output: 'Claim audit', next: 'Contento', href: '/auditgpt' },
  { id: 'fix', name: 'Fix', product: 'Contento', input: 'Approved claims', output: 'Governed content', next: 'AI Visibility', href: '/contento' },
  { id: 'monitor', name: 'Monitor', product: 'AI Visibility', input: 'Entity signals', output: 'Answer map', next: 'Recovery', href: '/ai-visibility' },
  { id: 'recover', name: 'Recover', product: 'Recovery', input: 'Missed demand', output: 'Follow-up workflow', next: 'Proof', href: '/recovery' },
  { id: 'prove', name: 'Prove', product: 'Proof', input: 'Evidence', output: 'Trust artifact', next: 'Agency', href: '/proof' },
  { id: 'deliver', name: 'Deliver', product: 'Agency', input: 'Client launch', output: 'Receipt packet', next: 'AuditGPT', href: '/agency' },
];
