  ...
  return (
    <section className="py-16 max-w-5xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="font-sans text-charcoal/70 max-w-2xl mx-auto">
      ...
      <div className="flex flex-wrap justify-center gap-4 mt-12">
        {['BAA Provided', 'SOC 2 audit in progress', 'AES-256 Encrypted', 'Privacy-First Ad Workflows'].map(badge => (
          <div key={badge} className="inline-flex items-center gap-2 px-4 py-2 bg-white/70 border border-charcoal/10 rounded-full text-xs font-semibold text-charcoal/70 font-sans">
