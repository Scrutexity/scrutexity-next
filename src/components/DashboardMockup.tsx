    ...
    <div className="relative w-full max-w-md mx-auto">
      <div className="bg-white/95 backdrop-blur-2xl border border-white/60 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 grid grid-cols-2 gap-6">
          <div>
            <div className="text-4xl font-semibold text-charcoal mb-1">14</div>
            <div className="text-sm text-charcoal/70">Consults Recovered</div>
            <div className="text-emerald-600 text-xs mt-1 font-medium">&uarr; 92% capture rate</div>
          </div>
          <div>
            <div className="text-4xl font-semibold text-charcoal mb-1">$28.4K</div>
            <div className="text-sm text-charcoal/70">Revenue Recovered</div>
        ...
        <div className="border-t border-white/60 bg-white/50 px-6 py-5 text-xs">
          <div className="flex justify-between mb-3">
            <span className="text-charcoal/70">Yesterday</span>
      ...
      <div className="absolute -top-4 -right-4 bg-white shadow-xl rounded-2xl px-5 py-3 text-center border border-white/70">
        ...
        <div className="text-[10px] text-charcoal/60 -mt-0.5">this week</div>
      </div>
    </div>
  );
}
