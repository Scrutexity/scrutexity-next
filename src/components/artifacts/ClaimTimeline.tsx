      ...
      <div className="mx-auto max-w-6xl">
        <Reveal>
          <ArtifactHeading
            ...
            italic="They drift."
            body="A claim that was supported in January can be unsupported by April — same words, vanished evidence. Drift monitoring catches the gap before a regulator does."
          />
        </Reveal>
