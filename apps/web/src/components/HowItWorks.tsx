        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative z-10">
          ...
          >
            ...
            <div className="w-full bg-white border border-[#6B8576]/30 rounded-xl p-3 font-mono text-[8px] space-y-1 mb-4 shadow-sm">
              ...
              <div className="text-gray-950 font-bold text-[10px]">Your practice's recovery ledger</div>
              <div className="text-[#6B8576]">Missed inquiries → routed to staff → deposit booked</div>
            </div>
