    ...
    <section ref={containerRef} className="py-28 bg-cream border-b border-sand-deep/60 relative z-10">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <MoseyBentoGrid className="mb-14 gap-5 md:grid-cols-2 lg:grid-cols-4">
          {[
            { label: 'Recovery Model', val: 0, prefix: '$', note: 'Calculated from your actual missed inquiries', delay: 0.05 },
            { label: 'Pipeline Status', val: 0, note: 'Your pilot will show your recovery rate', delay: 0.12 },
            { label: 'Response Delay', val: 0, suffix: '', note: 'Measured from your actual inquiry flow', delay: 0.19 },
              ...
              <div>
                ...
                {s.verified ? (
                  ...
                  <div className="flex items-baseline gap-1 mb-2">
                    <span className="font-display text-[2.75rem] leading-none inline-block origin-left text-espresso">—</span>
                  </div>
                )}
                <p className="text-sm text-[#9a8775] leading-relaxed">{s.note}</p>
              </div>
              {s.verified && (
              ...
              <div className="p-8 md:p-10">
                ...
                <div className="bg-cream/70 border border-sand-deep rounded-2xl p-6 mb-8 font-mono text-[10.5px] space-y-5 shadow-inner relative overflow-hidden">
                  ...
                  <div className="relative grid grid-cols-2 sm:grid-cols-4 gap-4 border-b border-sand-deep/60 pb-5">
                    {[
                      { label: 'Inquiries Observed', val: 0 },
                      { label: 'Leaks Identified', val: 0, terracotta: true },
                      { label: 'Recovery Rate', staticVal: 'Your pilot results' },
                      { label: 'Pipeline Value', staticVal: 'Calculated at Day 14', sage: true },
                    ].map((m, i) => (
                      <div key={i}>
