...
export default function ConsultationRecovery() {
  return (
    <section id="platform" className="py-24 px-6 lg:px-12 max-w-[1400px] mx-auto bg-cream">
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-start">
          <span className="text-clay font-sans font-semibold tracking-[0.15em] text-sm uppercase mb-4">
          ...
          <p className="font-sans text-lg text-espresso/70 mb-10 leading-relaxed">
          ...
          <div className="w-full max-w-md bg-white/60 backdrop-blur-md border border-charcoal/10 rounded-2xl p-8 shadow-sm">
            <div className="flex justify-between items-center mb-6 border-b border-charcoal/10 pb-4">
              <span className="font-sans font-semibold text-espresso">Recovered This Month</span>
              <span className="text-[10px] text-espresso/50 uppercase tracking-[0.2em] font-semibold border border-charcoal/10 px-2 py-1 rounded">Automated</span>
            </div>
            
            <div className="space-y-4 font-sans text-sm text-espresso/80 mb-8">
            ...
            <div className="flex justify-between items-end font-display pt-6 border-t border-charcoal/10">
              <span className="text-lg text-espresso/80">Leaked Revenue Captured</span>
              <span className="text-3xl text-clay font-semibold">Your pilot will show this number</span>
            </div>
          </div>
