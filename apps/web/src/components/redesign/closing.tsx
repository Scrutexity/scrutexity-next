  ...
  return (
    <section className="px-5 py-24 sm:px-8">
      <div className="mx-auto max-w-[1200px]">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl border border-accent/25 bg-gradient-to-b from-ink-soft/60 to-ink/60 px-6 py-16 text-center sm:px-12 sm:py-20">
            <div
              aria-hidden
              className="pointer-events-none absolute left-1/2 top-0 h-64 w-[560px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent/15 blur-[100px]"
            />
            <div className="relative">
              <h2 className="mx-auto max-w-[720px] text-3xl font-bold leading-tight tracking-tight text-ink sm:text-5xl">
      ...
      <div className="mx-auto max-w-[1200px]">
        <div className="grid gap-10 md:grid-cols-[1.2fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-[260px] text-[12.5px] leading-relaxed text-muted">
              ...
              <ul className="mt-4 space-y-2.5">
                {col.links.map(([label, href]) => (
                  <li key={label}>
                    <a
                      href={href}
                      className="text-[13px] text-ink/80 transition-colors hover:text-accent-text"
                    >
                      {label}
                    </a>
                  </li>
