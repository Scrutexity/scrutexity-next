      ...
      {isVisible && (
        ...
        >
          <div className="pointer-events-auto w-full max-w-sm">
            <Link
              href="/contact?intent=buyer-narrative-alignment-sprint&source=scrutexity-mobile-sticky"
              onClick={() =>
                trackEvent('cta_click', {
                  cta_label: 'Request the $1,500 Sprint - Mobile Sticky',
                  destination: '/contact?intent=buyer-narrative-alignment-sprint&source=scrutexity-mobile-sticky',
