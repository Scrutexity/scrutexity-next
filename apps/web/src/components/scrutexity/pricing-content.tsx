      ...
      <section className="border-b border-sand-deep/30 bg-bone px-5 pb-18 pt-28 sm:px-8 md:pb-24 md:pt-40">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <Link
            ...
            onClick={() => trackEvent("cta_click", { cta_label: "Start a Claim Support Review", destination: "/contact?intent=claim-support-review&source=scrutexity-pricing", section: "pricing-hero" })}
