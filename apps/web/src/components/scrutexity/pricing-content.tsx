      ...
      <section id="plans" className="px-6 py-20 bg-cream">
        <div className="max-w-[90rem] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 items-stretch">
            ...
            {/* 2.5 Claim Cleanup Record */}
            <PricingCard
              tier={{
                name: 'Claim Cleanup Record',
                price: '$1,997',
                cadence: 'one-time · done-for-you package',
                badge: 'Full Remediation',
                accent: 'clay',
                bestFor: 'Teams that want safer rewrites executed across a full site or campaign.',
                includes: [
                  'Full site / campaign claim exposure audit',
                  'Proof-gap matrix & evidence mapping exhibit',
                  'Safer rewrites executed across all flagged claims',
                  'AI Answer Reality Receipt',
                  'Final structured Claim Cleanup Record PDF'
                ],
                ctaLabel: 'Request Cleanup Record',
                ctaHref: '/contact?intent=claim-cleanup-record&source=pricing'
              }}
            />
