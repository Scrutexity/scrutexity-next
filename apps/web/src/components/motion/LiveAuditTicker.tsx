  ...
  return (
    <div className="absolute -top-2 -right-2 z-20 flex flex-col gap-1.5
      ...
      <div className="flex gap-4">
        <div>
          <p className="font-mono text-lg font-bold text-espresso tabular-nums">14-day</p>
          <p className="text-[8px] text-[#9a8775]">pilot</p>
        </div>
        <div>
          <p className="font-mono text-lg font-bold text-espresso tabular-nums">$0</p>
          <p className="text-[8px] text-[#9a8775]">if not proven</p>
        </div>
        <div>
          <p className="font-mono text-lg font-bold text-[#7f8f78] tabular-nums">parallel</p>
          <p className="text-[8px] text-[#9a8775]">install</p>
        </div>
      </div>
    </div>
  );
