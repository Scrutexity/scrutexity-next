...
export default function HeroDashboardMockup() {
  return (
    <div className="w-full max-w-5xl mx-auto rounded-[1.75rem] border border-sand-deep bg-cream shadow-[0_28px_90px_rgba(85,62,41,0.10)] select-none overflow-hidden md:h-[600px] flex flex-col justify-between backdrop-blur-sm">
      <style>{`
      ...
      {/* Header bar */}
      <div className="border-b border-sand-deep px-5 py-2.5 flex items-center justify-between bg-cream/90">
        <div className="flex items-center gap-2.5">
          <span className="h-2 w-2 rounded-full bg-[#b9825f] animate-pulse" />
          <span className="font-mono text-[11px] uppercase tracking-widest text-clay-deep">Consult Recovery Pipeline</span>
        </div>
        <span className="font-mono text-[10px] text-[#c4b4a0]">Boulevard → Mangomint → Ledger</span>
      </div>

      {/* Main grid */}
      <div className="relative flex-1 grid grid-cols-1 md:grid-cols-10 p-4 md:p-5 gap-4 items-stretch bg-cream">
        ...
        {/* LEFT: Boulevard */}
        <div className="md:col-span-3 flex flex-col justify-between rounded-xl border border-sand-deep bg-white/70 p-4 z-10 shadow-[0_2px_12px_rgba(85,62,41,0.05)]">
          <div>
            <div className="flex items-center justify-between border-b border-sand-deep pb-2.5 mb-4">
              <h3 className="font-display text-base tracking-tight text-espresso">Boulevard · NYC Flatiron</h3>
              <span className="rounded-full bg-[#f3eadf] px-2 py-0.5 text-[9px] font-semibold uppercase tracking-widest text-clay-deep">Source A</span>
            </div>
              ...
              {[
                ...
                <div key={idx} className="rounded-lg border border-[#f0c8b8]/60 bg-[#fdf6f2] p-2.5">
                  <div className="flex justify-between items-start mb-1">
                    <span className="font-mono text-[11px] font-medium text-espresso">{entry.time}</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="font-mono text-[11px] text-mist">Patient: {entry.initial}</span>
          ...
          <div className="mt-3 pt-2.5 border-t border-sand-deep flex items-center gap-1.5">
            <span className="h-1.5 w-1.5 rounded-full bg-[#b9825f] animate-pulse flex-shrink-0" />
            <span className="text-[10px] font-semibold text-clay">Unreconciled demand detected</span>
          </div>
        </div>

        {/* CENTER: Scrutexity */}
        <div className="md:col-span-4 flex flex-col justify-between rounded-xl border border-[#d8c4ae] bg-cream p-5 z-20 relative shadow-[0_8px_32px_rgba(185,130,95,0.12)]">
          ...
          <div className="relative">
            <div className="flex items-center gap-2 border-b-2 border-[#b9825f]/30 pb-3 mb-4">
              ...
              <h3 className="font-display text-lg tracking-tight text-espresso">Scrutexity Layer</h3>
            ...
            <div className="rounded-xl border border-sand-deep bg-white/60 p-4">
              <p className="font-mono text-[10px] uppercase tracking-wider text-clay-deep font-semibold mb-3">Matched Record</p>
              <div className="space-y-2 font-mono text-[11px]">
                {[
                  ...
                  <div key={key} className="flex justify-between py-1 border-b border-sand-deep/60 last:border-0">
          ...
          <div className="relative mt-4 rounded-lg border border-[#d8b17a]/40 bg-[#f3eadf] px-4 py-2.5 flex items-center gap-2">
            <ArrowRightLeft className="w-3.5 h-3.5 text-clay flex-shrink-0" />
            <span className="font-mono text-[10px] uppercase tracking-wider text-clay-deep font-semibold">Lead Matched Across EMRs</span>
          </div>
        </div>
        ...
        <div className="md:col-span-3 flex flex-col justify-between rounded-xl border border-sand-deep bg-white/70 p-4 z-10 shadow-[0_2px_12px_rgba(85,62,41,0.05)]">
          <div>
            <div className="flex items-center justify-between border-b border-sand-deep pb-2.5 mb-4">
              <h3 className="font-display text-base tracking-tight text-espresso">Mangomint · NYC SoHo</h3>
              <span className="rounded-full bg-[#f3eadf] px-2 py-0.5 text-[9px] font-semibold uppercase tracking-widest text-clay-deep">Source B</span>
            </div>
            <div className="space-y-2">
              <div className="rounded-lg border border-[#7f8f78]/30 bg-[#f4f7f4] p-2.5">
                <div className="flex justify-between items-start mb-1">
                  <span className="font-mono text-[11px] font-medium text-espresso">10:22 AM</span>
                  <span className="rounded-full bg-[#7f8f78]/12 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-[#7f8f78]">ROUTED ✓</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-mono text-[11px] text-mist">Patient: J.K.</span>
              ...
              <div className="rounded-lg border border-[#f0c8b8]/60 bg-[#fdf6f2] p-2.5 opacity-55">
                <div className="flex justify-between items-start mb-1">
                  <span className="font-mono text-[11px] font-medium text-espresso">04:10 PM</span>
                  <span className="rounded-full bg-[#8C4343]/10 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-[#8C4343]">MISSED</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-mono text-[11px] text-mist">Patient: S.M.</span>
      ...
      <div className="border-t border-sand-deep bg-[#f7f2ea] px-5 py-3">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 font-mono text-[11px] text-espresso">
            <span className="font-bold uppercase tracking-wider flex items-center gap-1.5">
              <CheckCircle2 className="w-3.5 h-3.5 text-clay" /> Consult Trail
            </span>
            <span className="text-[#c4b4a0]">·</span>
            <span className="text-espresso/70">3 consults matched</span>
            <span className="text-[#c4b4a0]">·</span>
            <span className="text-[#7f8f78]">1 routed to NP</span>
            <span className="text-[#c4b4a0]">·</span>
            <span className="text-clay">2 flagged for recovery</span>
          </div>
