...
const comparisons = [
  {
    ...
    baseline: 'Hours or next-day',
    systemState: 'Seconds — routed to your staff',
    icon: Clock,
    impact: 'Your team responds on their terms',
    ...
    <div className="rounded-[1.75rem] border-2 border-clay/20 bg-cream overflow-hidden">
      ...
      <div className="bg-[#f3eadf] px-6 py-4 border-b border-sand-deep">
        ...
        <p className="text-[12px] text-mist mt-1">
          Owners don&apos;t care about the AI. They care about whether their missed inquiries are being recovered.
        </p>
      </div>
