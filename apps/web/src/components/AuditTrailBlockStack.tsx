...
const ledgerData = {
  ...
  outcomes: [
    { id: 'dep', label: 'Missed Inquiries', metric: 'Captured → routed', highlight: false },
    { id: 'con', label: 'Staff-Approved Actions', metric: 'Your team decides', highlight: false },
    { id: 'rev', label: 'Recovery Pipeline', metric: 'Shown on Day 14', highlight: true },
  ],
  seals: [
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-bone/10 bg-creamone/[0.035] px-4 py-2">
            ...
            <span className="font-mono text-[10px] font-semibold uppercase tracking-[0.14em] text-porcelain/66">
              SHA-256 chain · every block sealed by hash
            </span>
          </div>
        </motion.div>
      </div>
