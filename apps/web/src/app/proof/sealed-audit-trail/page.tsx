...
export const metadata: Metadata = {
  ...
  description:
    "SHA-256 hashed claim records, monthly proof binders, and exportable evidence trails for governed growth infrastructure.",
};
...
const binderSections = [
  ...
  ["Export package", "Board, insurer, agency, and diligence-ready PDF/CSV packet with SHA-256 digests."],
];
