      ...
      <>
          ...
          <div className="max-w-3xl mx-auto p-10 font-sans text-[#221F1B]">
            <div className="border-b-2 border-[#221F1B] pb-6 mb-6">
              <div className="flex justify-between items-start">
                <div>
                  <p className="font-serif text-2xl mb-1">Claim Audit Receipt</p>
                  <p className="text-sm text-[#221F1B]/60">reviewed for regulatory risk and competitive positioning</p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-[#221F1B]/40 font-mono">ID: {receipt.id}</p>
                  <p className="text-xs text-[#221F1B]/40">{receipt.date}</p>
                </div>
              </div>
            </div>

            <div className="mb-8">
              <p className="text-xs uppercase tracking-wider text-[#221F1B]/40 mb-1">Submitted by</p>
              <p className="text-lg font-semibold">{receipt.name}</p>
              <p className="text-sm text-[#221F1B]/60">{receipt.organization}</p>
              <p className="text-sm text-[#221F1B]/60 font-mono break-all">{receipt.url}</p>
            </div>

            <div className="border border-[#221F1B]/10 p-6 mb-6">
              <p className="text-xs uppercase tracking-widest text-[#221F1B]/50 mb-3">What we audit</p>
        ...
        <div className="min-h-screen bg-[#fbf7ef] text-[#221f1b] font-sans antialiased flex items-center justify-center px-6">
          <div className="max-w-lg text-center">
            ...
            <h1 className="mt-6 font-serif text-4xl tracking-tight">Receipt generated</h1>
            ...
            <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 border border-[#221F1B]/10 bg-white text-xs font-mono text-[#221F1B]/50">
              ...
              <span className="text-[#221F1B] font-semibold">{receipt.id}</span>
        ...
        <div className="bg-[#efe6d7] border-t border-[#e1d4c5]">
          <div className="max-w-lg mx-auto text-center px-6 py-12">
            <h2 className="font-serif text-2xl text-[#221F1B] tracking-tight mb-3">
              Turn this receipt into a Claim Cleanup Record
            </h2>
            <p className="text-sm text-[#221F1B]/70 leading-relaxed mb-6">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#B9825F] text-[#FBF7EF] text-sm uppercase tracking-widest font-semibold hover:bg-[#221F1B] transition-all duration-300"
            >
    ...
    <div className="min-h-screen bg-[#fbf7ef] text-[#221f1b] font-sans antialiased">
      <section className="py-20 px-6 lg:px-16 max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-xs uppercase tracking-widest font-bold text-[#B9825F] mb-2">Pre-publish audit</p>
        ...
        <div className="border border-[#221F1B]/10 bg-white p-6 mb-10">
          <p className="text-xs uppercase tracking-widest font-semibold text-[#221F1B]/50 mb-3">We audit for</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="url" className="block text-xs uppercase tracking-widest font-semibold text-[#221F1B]/60 mb-1.5">
              Page URL to audit
            </label>
            <input
              id="url"
              ...
              className="w-full px-4 py-3 border border-[#221F1B]/15 bg-white text-sm text-[#221F1B] placeholder:text-[#221F1B]/30 focus:outline-none focus:border-[#B9825F] transition-colors font-mono"
            />
            {urlParam && (
              <p className="mt-2 text-xs text-[#221F1B]/50">
                From extension: <span className="font-mono text-[#221F1B]/70 break-all">{urlParam}</span>
              </p>
            )}
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            <div>
              <label htmlFor="organization" className="block text-xs uppercase tracking-widest font-semibold text-[#221F1B]/60 mb-1.5">
                Organization / Agency
              </label>
              <input
                id="organization"
        ...
        {/* Usage info */}
        <div className="mt-12 p-6 bg-[#efe6d7] rounded-lg border border-[#e1d4c5]">
          <p className="text-xs uppercase tracking-widest font-semibold text-[#221F1B]/70 mb-2">How to use this receipt</p>
          <ul className="space-y-2 text-sm text-[#221F1B]/60">
...
export default function Page() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#fbf7ef] flex items-center justify-center"><div className="text-sm text-[#221F1B]/50">Loading...</div></div>}>
      <ClaimReceiptForm />
    </Suspense>
  );
}
