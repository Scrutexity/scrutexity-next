      ...
      <main className="mx-auto max-w-5xl px-5 py-16 sm:px-8 lg:py-24">
        ...
        <section className="mt-20 rounded-[1.75rem] border border-sand-deep bg-cream-deep p-8">
          ...
          <p className="mt-4 text-sm leading-7 text-mist">
            Multi-location operators in PE-backed portfolios face a different compliance bar. Scrutexity Compliance+ includes SOC 2 evidence collection via Vanta, BAAs on request for every connected location, and the deterministic clinical stop-rule configured to your state medical board guidelines.
          </p>
        ...
        <section className="mt-20">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {[
              ...
              'BAA on request per tenant. Governance scales with the portfolio.',
